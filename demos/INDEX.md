...
remembered: 2 `pushed`, 31 `validated`, 1 `superseded`.** `pushed` was missing from this
...
| 10 | [expand-contract-live-demo](https://github.com/mselser95/expand-contract-live-demo) | a schema change under live traffic with two app versions running at once, zero failed requests — and the one-shot ALTER measured holding ACCESS EXCLUSIVE on a rehearsal | Rae et al., F1 (VLDB 2013) | §19 `schema_evolution` | [A] | `validated` |
